...
print(f"SCRAPINGDOG_API_KEY = {'[SET]' if SCRAPINGDOG_API_KEY else '[NOT SET]'}")
...
LINKEDIN_DATA_SERVICE = "scrapingdog" if SCRAPINGDOG_API_KEY else "brightdata" if BRIGHTDATA_API_KEY else "mock"

# Print configuration summary
print("\nConfiguration loaded:")
print(f"- Upload directory: {UPLOAD_DIR}")
print(f"- OpenAI mode: {'Production' if OPENAI_API_KEY != 'demo_mode' else 'Demo'}")
print(f"- LinkedIn data service: {LINKEDIN_DATA_SERVICE.capitalize()}")
